    ...
    generate: function(processChunk, node) {
        ...
        if (a) {
            switch (node.a) {
                case '+1':
                case '1':
                    processChunk('n', IDENTIFIER);
                    break;
                case '-1':
                    processChunk('-n', IDENTIFIER);
                    break;
                default:
                    processChunk(node.a, NUMBER);
                    processChunk('n', IDENTIFIER);
            }
            ...
            if (b) {
                ...
                if (b.charAt(0) === '-' || b.charAt(0) === '+') {
                    processChunk(b.charAt(0), PUNCTUATOR);
                    processChunk(b.substr(1), NUMBER);
                } else {
                    processChunk('+', PUNCTUATOR);
                    processChunk(b, NUMBER);
                }
            }
        } else {
            processChunk(String(node.b), NUMBER);
        }
    }
};
